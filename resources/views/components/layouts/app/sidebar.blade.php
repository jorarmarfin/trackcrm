    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <div x-data="{ sidebarOpen: true }" class="flex min-h-screen">
            <button @click="sidebarOpen = !sidebarOpen"
                    class="top-12 p-2 text-sm text-gray-600 hover:text-gray-900 focus:outline-none fixed top-2 left-2 z-50 bg-white shadow rounded">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          d="M4 6h16M4 12h16M4 18h16" />
                </svg>
            </button>
            <aside x-show="sidebarOpen" class="w-64 bg-white shadow-md h-screen transition-all duration-300">
